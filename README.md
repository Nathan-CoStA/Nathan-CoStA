...
| Área | Foco |
|---|---|
| **ERM** | Gestão integrada de riscos corporativos, frameworks (COSO, ISO 31000) |
| **Risco de Mercado** | VaR, stress testing, sensibilidade a taxas e câmbio |
| **Risco de Crédito** | Modelos de scoring, probabilidade de default (PD), inadimplência |
| **M&A** | Avaliação de empresas (valuation), due diligence, análise de sinergias |
| **Fraude** | Detecção de padrões anômalos, machine learning para fraude transacional |

---

### 📌 Status atual

> 🚧 Construindo meu portfólio de projetos! Em breve repositórios aplicando Python, R, SQL e Power BI em casos de risco de crédito, risco de mercado e detecção de fraude.
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=Nathan-CoStA&show_icons=true&theme=default" />
</p>

---

<p align="center"><i>Aberto a conexões, trocas de conhecimento e oportunidades nas áreas de Risk Management e M&A 🚀</i></p>
